...
| 3 | in-progress | 2026-07-15 | — | COLLECTIONS and CURL commits plus CODEGEN patch | Collection transactions, cURL parsing/preview, seven stable codegen goldens, and all 49 target/body fixture combinations passed available parser/compiler checks | CODEGEN checkpoint: `npm run validate` passed with 75 unit, 13 integration, 4 extension-host tests, zero audits, production builds, VSIX, and 9-file payload allowlist | COMMANDS remains; current 299 KiB webview performance advisory remains deferred to UI/REFACTOR |
| 4 | planned | — | — | — | — | — | None yet |
| 5 | planned | — | — | — | — | — | None yet |
