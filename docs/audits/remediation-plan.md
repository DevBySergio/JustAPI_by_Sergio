...
| 3 | in-progress | 2026-07-15 | — | Working-tree COLLECTIONS patch | Six focused collection transaction/import tests plus protocol and redacted-export regressions passed | COLLECTIONS checkpoint: `npm run validate` passed with 58 unit, 13 integration, 4 extension-host tests, zero audits, production builds, VSIX, and 9-file payload allowlist | CURL, CODEGEN, and COMMANDS remain; pre-existing 293 KiB webview performance advisory remains |
| 4 | planned | — | — | — | — | — | None yet |
| 5 | planned | — | — | — | — | — | None yet |
