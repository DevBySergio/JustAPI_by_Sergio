...
| 3 | in-progress | 2026-07-15 | — | COLLECTIONS commit plus working-tree CURL patch | COLLECTIONS transaction/import coverage plus browser/Postman cURL fixtures, parser edge cases, structured warnings, protocol validation, preview contracts, and generated-cURL round trip passed | CURL checkpoint: `npm run validate` passed with 68 unit, 13 integration, 4 extension-host tests, zero audits, production builds, VSIX, and 9-file payload allowlist | CODEGEN and COMMANDS remain; current 298 KiB webview performance advisory remains deferred to UI/REFACTOR |
| 4 | planned | — | — | — | — | — | None yet |
| 5 | planned | — | — | — | — | — | None yet |
