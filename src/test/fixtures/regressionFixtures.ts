...
export const regressionFixtures: readonly RegressionFixture[] = [
  ...
  { id: 'transport-compression', area: 'transport', owner: 'HTTP', status: 'active', purpose: 'Compressed response decoding contract' },
  { id: 'transport-limits', area: 'transport', owner: 'HTTP', status: 'active', purpose: 'Bounded response and redirect limits' },
  ...
  { id: 'variables-precedence-cycles', area: 'variables', owner: 'VARIABLES', status: 'active', purpose: 'Precedence, cycles, and replacement bounds' },
  { id: 'storage-corruption', area: 'storage', owner: 'STORAGE', status: 'active', purpose: 'Corrupt JSON read behavior' },
  { id: 'storage-migration', area: 'storage', owner: 'STORAGE', status: 'active', purpose: 'Legacy-to-v2 migration and recovery' },
  ...
  { id: 'secret-storage', area: 'security', owner: 'AUTH', status: 'active', purpose: 'SecretStorage migration and reference lifecycle' },
  { id: 'redaction', area: 'security', owner: 'AUTH', status: 'active', purpose: 'Recursive artifact redaction' },
