...
export const regressionFixtures: readonly RegressionFixture[] = [
  ...
  { id: 'protocol-validation', area: 'protocol', owner: 'PROTOCOL', status: 'contract', purpose: 'Malformed, oversized, and unknown messages' },
  { id: 'protocol-errors', area: 'protocol', owner: 'PROTOCOL', status: 'contract', purpose: 'Stable error envelopes and operation correlation' },
  ...
  { id: 'stale-responses', area: 'webview', owner: 'UI', status: 'contract', purpose: 'Ignore results from superseded executions' },
